...
Two ways to run:
    ...
    python  -m ficsync            console, logs to the window (best for debugging)
    pythonw -m ficsync --tray     no window at all, tray icon, logs to a file
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog="ficsync")

...
const { fieldIsOpen } = await import("../ficsync/static/detail.js");
...
localStorageStore.set("ficsync_field_open_#readinglist", "0");
localStorageStore.set("ficsync_field_open_tags", "1");
